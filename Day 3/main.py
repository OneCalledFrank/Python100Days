...
if camino == "derecha":
    ...
    ambiente = input(
        "¿Quieres tomar la escopeta o ir por el arma de plasma?\n").lower()
    if ambiente == "arma de plasma":
        print("Puedes matar al barón del infierno.")
        print("Sigues avanzando.")
        llave = input(
            "Hay tres puertas, ¿Cuál eliges? Roja, Amarilla o Azul\n").lower()
        if llave == "roja":
            print("La llave roja te lleva al infierno.")
            print("Game Over.")
        elif llave == "amarilla":
            print(
                "Llegaste al final con poca vida, lograste completar DOOM, la aventura de texto")
            print("Felicidades.")
        else:
